...
$(document).ready(function () {
  ...
  function getNumberOfChosenImage(arrayOfImages) {
    var currentImage = $('#modal-with-images').find('img').attr('src');
  ...
  function getNameOfCurrentImage() {
    var currentImg = $('#modal-with-images').find('img');
    var src = $(currentImg).attr('src'); // "static/images/banner/blue.jpg"

    var tarr = src.split('/'); // ["static","images","banner","blue.jpg"]

    var nameOfCurrentImage = tarr[tarr.length - 1];
  ...
  var inputContentToAdd = "<div class=\"form-group row\">" + "<label for=\"images\" class=\"col-md-4 col-form-label text-md-right\">Additional image</label>" + "<div class=\"col-md-6\">" + "<input type=\"file\" name=\"images[]\" title=\"Upload one or few pictures\">" + "</div>" + "</div>";
  ...
  $(document).on('click', '#btnAdderCategoryToList', function (e) {
    var alreadyExistCategories = $('#divWithCategoriesList').find('div');
    var isExist = false;

    for (var i = 0; i < alreadyExistCategories.length; i++) {
    ...
    if (isExist) {
      ...
      var htmlToAdd = '<div id="' + $('#categoriesToAdd option:selected').val() + '"><i class="fa fa-minus-circle my-cursor-pointer i-deleter" title="Delete this category"></i><span> ' + $('#categoriesToAdd option:selected').text() + '</span>\n' + '<input type="hidden" name="categories[]" value="' + $('#categoriesToAdd option:selected').val() + '">\n' + '</div>';
  ...
  $('.div-item-main-container').mouseover(function () {
    $(this).find('.hide').css('display', 'block'); // $(this).css('box-shadow', '0px 2px 1px #888');
      ...
      $.get("/categories/root/list", function (data) {
        $.each(data, function (index, value) {
          if (index < data.length / 2) {
            $("#divToShowRootCategories1").append(createDivElementForRootCatgoryLink(value['id'], value['category_name']));
          } else {
            $("#divToShowRootCategories2").append(createDivElementForRootCatgoryLink(value['id'], value['category_name']));
          }
        });
      }, "json");
    } else {
  ...
  function createDivElementForRootCatgoryLink(id, name) {
    return divElementForRootCatgoryLink = '<div class="col-lg-12 popup-root-categories-item">' + '<a href="/product/category/' + id + '">' + name + '</a>' + '</div>';
  }
...
__webpack_require__(/*! /home/maxim/www/shop/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/maxim/www/shop/resources/sass/app.scss */"./resources/sass/app.scss");
