<div class="form-group row">
    <div class="col-md-10 offset-md-1 mt-2">
        <div class="row d-flex justify-content-between flex-wrap pl-2 pr-2">
            <div class="col-lg-2 col-md-2 url_no_decoration w-100 mb-1 p-1">
            ...
            <div class="col-lg-2 col-md-2 url_no_decoration text-center w-100 mb-1 p-1">
            ...
            <div class="col-lg-2 col-md-2 url_no_decoration text-right w-100 mb-1 p-1">
