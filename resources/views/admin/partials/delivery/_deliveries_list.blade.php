                ...
                @foreach($deliveries->sortBy('id') as $delivery)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('delivery.destroy', ['id'=>$delivery->id])}}" title="{{__('text.delete_this_delivery')}}" data-confirm="{{__('actions.really_delete?')}}" class="btn btn-secondary float-right url_no_decoration btnToDeletePhone">
