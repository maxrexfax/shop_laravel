...
<div class="card">
    ...
    <a href="{{route('phone.create', ['store_id' => $store->id])}}" title="{{__('actions.add_new_phone')}}" class="float-right btn btn-secondary url-no-decoration">{{__('actions.add_phone')}}<i class="fa fa-plus-square fa-lg ml-2" aria-hidden="true"></i></a>
    </div>
