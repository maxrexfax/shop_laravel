...
@section('admin.content')
    <div class="card">
        <div class="card-header text-center">
            ...
            <a id="userCreateButton" class="url_in_accordion ml-2 mb-0 float-right" href="{{route('user.create')}}">
        ...
        <div class="col-12 p-0 overflow-auto">
            <table id="tableWithUsersData" class="table table-striped w-100">
                ...
                @foreach($users->sortBy('id') as $user)
                    <tr>
                        ...
                        <td>{{$user->email}}</td>
                        <td><a id="edit{{$user->id}}" href="{{route('user.edit', [ 'id' => $user->id ])}}"><i class="fas fa-pencil-alt"></i></a></td>
                        <td>
