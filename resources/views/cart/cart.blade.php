        ...
        <div class="shopping-cart-main">
            ...
            <div class="row">
                ...
                <div class="parent-for-scroll col-md-11">
                    @if(!empty($cart->productRows))
                        <i class="fa fa-chevron-left scroll-product-control scroll-left-btn" aria-hidden="true"></i>
                        <i class="fa fa-chevron-right scroll-product-control scroll-right-btn" aria-hidden="true"></i>
                    @endif
                    <div class="d-flex justify-content-between align-items-center div-products-category-container">
                        @if(!empty($cart->productRows))
