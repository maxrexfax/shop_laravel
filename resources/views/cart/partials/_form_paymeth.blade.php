...
<input type="radio" id="paymentMethod0" value="0" name="payment_method_name" class="payment-methods-select" form="checkoutForm" required>
...
@foreach($paymentMethods as $paymentMethod)
    <div id="{{$paymentMethod->id}}">
        ...
        <input id="paymentMethod{{$paymentMethod->id}}" type="radio" value="{{$paymentMethod->payment_method_code}}" name="payment_method_name" class="payment-methods-select" form="checkoutForm" required>
