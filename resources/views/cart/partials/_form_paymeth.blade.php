...
@foreach($paymentMethods as $paymentMethod)
    <input type="radio" id="paymentMethod{{$paymentMethod->id}}" value="{{$paymentMethod->id}}" name="payment_method" class="payment-methods-select" form="checkoutForm" required>
    <label for="paymentMethod{{$paymentMethod->id}}">{{$paymentMethod->pm_name}}</label><br>
    <div id="containerForPayMethod{{$paymentMethod->id}}" class="details-for-payment-method"></div>
@endforeach
@endif
...
<div class="pay-method-details-2">Pay pay pay pay</div>

<div class="pay-method-details-3">Cash Cash Cash Cash </div>