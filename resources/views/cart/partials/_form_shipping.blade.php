<input type="radio" id="deliveryType0" value="0" name="delivery" class="select-type-of-delivery-in-cart" form="checkoutForm" @if(empty($cart->deliveryId)) checked @endif>
