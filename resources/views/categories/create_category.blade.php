...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-center">{{ __('text.category_create') }}</div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('category.create') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="category_name" type="text" class="form-control @error('catname') is-invalid @enderror" name="category_name" value="" placeholder="{{__('text.enter_category_name')}}" required>
