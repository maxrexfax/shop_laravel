        ...
        <div class="dropdown-content">
            @if($phones)
                @forelse($phones as $phone)
                    <a class="comp-dropdown-item mb-0 url-no-decoration phones-size-text text-white p-1" title="{{$phone->phone_info}}" href="tel:{{$phone->phone_number}}">{{$phone->phone_number}}</a>
                @empty
